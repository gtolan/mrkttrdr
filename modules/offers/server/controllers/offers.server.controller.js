...
/**
 * Mark review for task owner as completed
 */
exports.markTaskOwnerReviewCompleted = function(req, res) {
  Offer.findOneAndUpdate({
    _id: req.params.offerId
  }, {
    '$set': {
