...
exports.invokeRolesPolicies = function () {
  acl.allow([{
    ...
    allows: [{
      ...
      resources: '/api/tasks/:taskId/offers',
      permissions: '*'
    }, {
      resources: '/api/tasks/:taskId/delete-comment',
      permissions: ['post']
    }]
  }, {
    roles: ['user'],
    allows: [{
      ...
      resources: '/api/tasks/:taskId/comment-alert',
      permissions: ['post']
    }, {
      resources: '/api/tasks/:taskId/offer-alert',
      permissions: ['post']
    }]
  }, {
    roles: ['guest'],
